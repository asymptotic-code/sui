...
raw = _run_sui_prover_sync('/Users/cos/asymptotic/agent/clients/mysten/sui/crates/sui-framework/packages/sui-system/specs', args=['--functions', 'split_fungible_staked_sui_spec', '--timeout', '120', '--force-timeout', '--cloud'], timeout=300, env=None, run_on='remote')
...
### Code `toolu_0144LhbiPWu9cgonFXC6FG8E`

```python
from foxy.skills.sui_prover.api import _run_sui_prover_sync
import json

raw = _run_sui_prover_sync('/Users/cos/asymptotic/agent/clients/mysten/sui/crates/sui-framework/packages/sui-system/specs', args=['--functions', 'split_fungible_staked_sui_spec', '--timeout', '120', '--force-timeout', '--cloud'], timeout=300, env=None)
result = json.loads(raw)
output = result.get('output') or result.get('partial_output') or result.get('error', '')
foxy_inspect(output)
...
> 347 in, 208 out, 137331 cache read, 5852 cache create

### Result `toolu_0144LhbiPWu9cgonFXC6FG8E`

<!-- {"executed":true,"stdout":"/var/folders/n2/rx0nqjvn0px8cv2gw3x6f1ww0000gn/T/foxy_stdout_kc4ilnte.txt","to_foxy_logs":"\ud83d\udd04 staking_pool_specs::split_fungible_staked_sui_spec_Check\n\ud83d\udd04 staking_pool_specs::split_fungible_staked_sui_spec_Assume\n\ud83d\udd04 staking_pool_specs::split_fungible_staked_sui_spec_SpecNoAbortCheck\n\u2705 staking_pool_specs::split_fungible_staked_sui_spec_SpecNoAbortCheck\n\u2705 staking_pool_specs::split_fungible_staked_sui_spec_Assume\n\u2705 staking_pool_specs::split_fungible_staked_sui_spec_Check\nVerification successful"} -->
```
🔄 staking_pool_specs::split_fungible_staked_sui_spec_Check
🔄 staking_pool_specs::split_fungible_staked_sui_spec_Assume
🔄 staking_pool_specs::split_fungible_staked_sui_spec_SpecNoAbortCheck
...
### Code `toolu_01AjNyAWdYkNwkmRwNfmgywa`

```python
final_result({
    "summary": "PASS split_fungible_staked_sui_spec",
    "details": [
        "PASS split_fungible_staked_sui_spec_Check",
        "PASS split_fungible_staked_sui_spec_Assume",
        "PASS split_fungible_staked_sui_spec_SpecNoAbortCheck",
    ],
    "passed": 1,
    "failed": 0,
    "timeout": 0,
...
> 254 in, 175 out, 143183 cache read, 555 cache create

### Result `toolu_01AjNyAWdYkNwkmRwNfmgywa`

<!-- {"executed":true,"return_value":{"summary":"PASS split_fungible_staked_sui_spec","details":["PASS split_fungible_staked_sui_spec_Check","PASS split_fungible_staked_sui_spec_Assume","PASS split_fungible_staked_sui_spec_SpecNoAbortCheck"],"passed":1,"failed":0,"timeout":0}} -->
```
✓ ok
```
...
| model | claude-sonnet-4-6 |
| prompt | f9099c8767619d4f15bd0fe2838ab1020d88bf12635d5d350361427bf1ad519f |
| parent | /Users/cos/asymptotic/agent/clients/mysten/sui/.foxy/sessions/spec_improve_20260616_000130_3629 |
| turns | 2 |
| tool_calls | 2 |
| time | 11.17s |
| ended_at | 2026-06-16T00:02:23.374002 |
| cost | $0.1157 |
| tokens | 601 in / 383 out |
| cache | 280514 read / 6407 create |
