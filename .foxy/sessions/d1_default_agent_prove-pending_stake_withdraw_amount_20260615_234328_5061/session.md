...
raw = _run_sui_prover_sync('/Users/cos/asymptotic/agent/clients/mysten/sui/crates/sui-framework/packages/sui-system/specs', args=['--timeout', '120', '--force-timeout', '--cloud', '--functions', 'pending_stake_withdraw_amount_spec'], timeout=300, env=None, run_on='remote')
...
### Code `toolu_01EbKSzpxLQLDkgrfu5oE7Ct`
...
> 345 in, 210 out, 137331 cache read, 115833 cache create

### Result `toolu_01EbKSzpxLQLDkgrfu5oE7Ct`

<!-- {"executed":true,"stdout":"/var/folders/n2/rx0nqjvn0px8cv2gw3x6f1ww0000gn/T/foxy_stdout_xbi__d7j.txt","to_foxy_logs":"\ud83d\udd04 staking_pool_specs::pending_stake_withdraw_amount_spec_Check\n\ud83d\udd04 staking_pool_specs::pending_stake_withdraw_amount_spec_Assume\n\ud83d\udd04 staking_pool_specs::pending_stake_withdraw_amount_spec_SpecNoAbortCheck\n\u2705 staking_pool_specs::pending_stake_withdraw_amount_spec_Assume\n\u2705 staking_pool_specs::pending_stake_withdraw_amount_spec_Check\n\u2705 staking_pool_specs::pending_stake_withdraw_amount_spec_SpecNoAbortCheck\nVerification successful"} -->
```
🔄 staking_pool_specs::pending_stake_withdraw_amount_spec_Check
🔄 staking_pool_specs::pending_stake_withdraw_amount_spec_Assume
🔄 staking_pool_specs::pending_stake_withdraw_amount_spec_SpecNoAbortCheck
...
### Code `toolu_01BdAFEAJHDWECUrkzxu9XLW`

```python
final_result({
    "report": "PASS pending_stake_withdraw_amount_spec (_Check, _Assume, _SpecNoAbortCheck all passed)\n\nTotal: 1 passed / 0 failed / 0 timeout",
    "exit_code": result.get("exit_code", 0),
    "status": "success"
})
```

> 243 in, 138 out, 253164 cache read, 555 cache create

### Result `toolu_01BdAFEAJHDWECUrkzxu9XLW`

<!-- {"executed":true,"return_value":{"report":"PASS pending_stake_withdraw_amount_spec (_Check, _Assume, _SpecNoAbortCheck all passed)\n\nTotal: 1 passed / 0 failed / 0 timeout","exit_code":0,"status":"success"}} -->
```
✓ ok
```
...
| model | claude-sonnet-4-6 |
| prompt | afa3e7137c2940ff367bf4a89d166297894a9e5dfac5f0495bf54ed5e057c32c |
| parent | /Users/cos/asymptotic/agent/clients/mysten/sui/.foxy/sessions/spec_improve_20260615_234211_5941 |
| turns | 2 |
| tool_calls | 2 |
| time | 11.01s |
| ended_at | 2026-06-15T23:43:39.514753 |
| cost | $0.5606 |
| tokens | 588 in / 348 out |
| cache | 390495 read / 116388 create |
