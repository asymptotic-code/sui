...
token_budget: null
harness: foxy
parent_session: /Users/cos/asymptotic/agent/clients/mysten/sui/.foxy/sessions/spec_improve_20260615_233959_4382
...
raw = _run_sui_prover_sync('/Users/cos/asymptotic/agent/clients/mysten/sui/crates/sui-framework/packages/sui-system/specs', args=['--functions', 'pending_stake_amount_spec', '--timeout', '60', '--force-timeout', '--cloud'], timeout=240, env=None, run_on='remote')
...
### Code `toolu_01NfVRryjziqxQV7zzdCxmK6`

```python
from foxy.skills.sui_prover.api import _run_sui_prover_sync
import json

raw = _run_sui_prover_sync('/Users/cos/asymptotic/agent/clients/mysten/sui/crates/sui-framework/packages/sui-system/specs', args=['--functions', 'pending_stake_amount_spec', '--timeout', '60', '--force-timeout', '--cloud'], timeout=240, env=None)
result = json.loads(raw)
output = result.get('output') or result.get('partial_output') or result.get('error', '')
foxy_inspect(output)
```

> 343 in, 202 out, 137331 cache read, 5246 cache create

### Result `toolu_01NfVRryjziqxQV7zzdCxmK6`

<!-- {"executed":true,"stdout":"/var/folders/n2/rx0nqjvn0px8cv2gw3x6f1ww0000gn/T/foxy_stdout_nptyex8x.txt","to_foxy_logs":"\ud83d\udd04 staking_pool_specs::pending_stake_amount_spec_Check\n\ud83d\udd04 staking_pool_specs::pending_stake_amount_spec_Assume\n\ud83d\udd04 staking_pool_specs::pending_stake_amount_spec_SpecNoAbortCheck\n\u2705 staking_pool_specs::pending_stake_amount_spec_Assume\n\u2705 staking_pool_specs::pending_stake_amount_spec_SpecNoAbortCheck\n\u2705 staking_pool_specs::pending_stake_amount_spec_Check\nVerification successful"} -->
```
🔄 staking_pool_specs::pending_stake_amount_spec_Check
🔄 staking_pool_specs::pending_stake_amount_spec_Assume
🔄 staking_pool_specs::pending_stake_amount_spec_SpecNoAbortCheck
